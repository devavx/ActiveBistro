	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-sm-10 col-12 mx-auto">
				<form id="msform" class="shadow p-3 mt-5 mb-5" action="{{route('cart.index')}}">
					<ul id="progressbar">
					...
					<fieldset class="paddingrl">
							...
							<div class="col-lg-10 col-sm-10 col-12 mx-auto">
								...
								<table class="table table-striped table-bordered">
									<tr class="text-center">
										...
										<td class="p-2 w-50" colspan="2">{{ getCalories($userGender,$weightInKG,$heighIntCM,$age) }}
											kcal
										</td>
									</tr>
						...
						<button type="submit" class="btn btn-info  mt-3 float-right rounded btn-md">Next
