...
@section('title') Admin | Item Type @endsection
		...
		<div class="container-fluid">
			...
			<div class="row page-titles">
				<div class="col-md-5 align-self-center">
					<h4 class="text-themecolor">Item Type List</h4>
				</div>
				<div class="col-md-7 align-self-center text-right">
					<div class="d-flex justify-content-end align-items-center">
						...
						<a href="{{ url('/admin/item_type/create') }}" class="btn btn-info d-none d-lg-block m-l-15"><i
										...
										@foreach($listData as $rows)
											<tr>
												...
												<td style="text-align: center; ">
													<a class="like" href="{{ route('admin.item_type.edit',$rows->id) }}" title="Edit"><i class="fas fa-edit text-info"></i></a>
													/
		...
		<div class="modal-dialog modal-xl" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Item Type Detail</h4>
...
@section('script')
	...
	<script>
		...
		function confirmDelete(id) {
			url = "{{ url('/admin/item_type/delete/') }}/" + id;
		...
		$(document).ready(function () {
			$(document).on('click', '.change_status', function () {
				var id = $(this).attr('id');
				url = "{{ url('/admin/item_type/change_status/') }}/" + id;
		...
		function confirmDeleteBulk() {
			const url = "{{ url('/admin/item_type/delete') }}";
			const items = [];
