...
@section('content')
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="card">
						...
						@endif
						<div class="card-body">
							<form action="{{ route('admin.how_it_works.store') }}" id="add_form" method="post" enctype="multipart/form-data">
								@csrf
								<div class="form-body">
									<hr>
									<div class="row">
  ...
  <label class="badge badge-light btn btn-success" style="pointer-events: none;" type="button" disabled>?</label>
												...
												<input type="file" name="image" id="title" class="form-control" placeholder="Choose an icon..." accept=".jpg, .jpeg, .png" required>
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group">
												<label for="title">Title</label>
												<input type="text" name="title" id="title" minlength="2" maxlength="255" placeholder="Enter title..." class="form-control" required>
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group">
