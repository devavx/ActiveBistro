			...
			<div class="row">
				<div class="col-lg-12">
					<div class="card">
						...
						@endif
						<div class="card-body">
							<form action="{{ route('admin.category.update',$category->id) }}" method="post" id="add_form">
								@csrf
								@method('PUT')
								<div class="form-body">
									<hr>
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label>Name*</label>
												<input type="text" name="name" id="name" class="form-control" placeholder="Enter name.." value="{{ $category->name }}" minlength="2" maxlength="50" required>
											</div>
										</div>
									</div>
								</div>
								<div class="form-actions">
									...
									<a href="{{ route('admin.category.index') }}" class="btn btn-inverse">Cancel</a>
								</div>
							</form>
						</div>
					</div>
