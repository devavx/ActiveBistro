...
@section('title') Admin | Ingredient @endsection
		...
		<div class="container-fluid">
			...
			<div class="row page-titles">
				<div class="col-md-5 align-self-center">
					<h4 class="text-themecolor">Ingredient List</h4>
				</div>
				<div class="col-md-7 align-self-center text-right">
					<div class="d-flex justify-content-end align-items-center">
						...
						<a href="{{ url('/admin/ingredient/create') }}" class="btn btn-info d-none d-lg-block m-l-15"><i
										...
										@foreach($listData as $rows)
											<tr>
												...
												<td style="text-align: center; ">
													<a class="like" href="{{ route('admin.ingredient.edit',$rows->id) }}" title="Edit"><i class="fas fa-edit text-info"></i></a>
													/
...
@section('script')
	...
	<script>
		...
		function confirmDeleteBulk() {
			const url = "{{ url('/admin/ingredient/delete') }}";
			const items = [];
