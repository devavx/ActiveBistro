...
@section('title') Admin | Postal Codes @endsection
		...
		<div class="container-fluid">
			...
			<div class="row page-titles">
				<div class="col-md-5 align-self-center">
					<h4 class="text-themecolor">Postal Codes List</h4>
				</div>
				<div class="col-md-7 align-self-center text-right">
					<div class="d-flex justify-content-end align-items-center">
						...
						<a href="{{ url('/admin/postal_codes/create') }}" class="btn btn-info d-none d-lg-block m-l-15"><i
			...
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">Postal Codes List</h4>
									...
									@if(!empty(@listData))
										@foreach($listData as $rows)
											<tr>
												...
												<td> {{ \App\Core\Primitives\Str::ellipsis($rows->description ?? '-',25)}}</td>
												@if($rows->active)
													<td>
												...
												<td>
													<a class="like" href="{{ route('admin.postal_codes.edit',$rows->id) }}" title="Edit"><i class="fas fa-edit text-info"></i></a> /
...
@section('script')
	...
	<script>
		...
		function confirmDeleteBulk() {
			const url = "{{ url('/admin/postal_codes/delete') }}";
			const items = [];
